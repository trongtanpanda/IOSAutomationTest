...
public class TC02_CanReserveATwinRoom extends TestBaseHotel {

    @Test()
    @Description("テスト: ツイン部屋を予約できる")
    public void TC04() {
        ...
        roomReservationPage.inputCheckInDayForSearch(TestConstants.PT2_TC02_DAY_FOR_SEARCH);
        ...
        bookingRoomPage.selectDate(TestConstants.PT2_TC02_CHECK_IN_DAY, TestConstants.PT2_TC02_CHECK_OUT_DAY);
