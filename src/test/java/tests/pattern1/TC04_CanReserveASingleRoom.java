...
public class TC04_CanReserveASingleRoom extends TestBaseHotel {

    @Test()
    @Description("テスト: シングル部屋を予約できる")
    public void TC04() {
        ...
        roomReservationPage.inputCheckInDayForSearch(TestConstants.TC04_DAY_FOR_SEARCH);

        Logger.info("2．シングルボタンを押下");
        roomReservationPage.selectRoomType(RoomType.SINGLE);
        ...
        bookingRoomPage.selectDate(TestConstants.TC04_CHECK_IN_DAY, TestConstants.TC04_CHECK_OUT_DAY);
